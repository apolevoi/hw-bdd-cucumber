#Making sure one string is in front of other: https://stackoverflow.com/questions/9741716/regular-expression-to-match-if-string-a-appears-before-string-b-on-a-page-using
